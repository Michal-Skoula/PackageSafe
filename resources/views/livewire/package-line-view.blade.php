<div wire:poll.30000ms="getData" class="w-full flex items-center justify-between bg-gray-900 px-5 py-3 rounded-xl">
    <div class="flex items-center gap-3">
       <div class="p-3 rounded-xl h-full bg-gray-950 bg-opacity-[40%]">
           <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
               <path class="fill-current text-gray-300" d="M440-183v-274L200-596v274l240 139Zm80 0 240-139v-274L520-457v274Zm-80 92L160-252q-19-11-29.5-29T120-321v-318q0-22 10.5-40t29.5-29l280-161q19-11 40-11t40 11l280 161q19 11 29.5 29t10.5 40v318q0 22-10.5 40T800-252L520-91q-19 11-40 11t-40-11Zm200-528 77-44-237-137-78 45 238 136Zm-160 93 78-45-237-137-78 45 237 137Z"/>
           </svg>
       </div>
        <div class="py-3 px-2 rounded-xl h-full flex items-stretch">
            <p><span class="text-gray-400">Číslo objednávky: </span>{{$tower_name}}</p>
        </div>
        <x-order-status status="{{$tower_status}}"/>
    </div>
    <div class="flex flex-row gap-4 items-center">
        <div class="flex items-center gap-2 rounded-xl bg-gray-950 bg-opacity-[40%] p-1">
            <x-value-with-icon-inline unit="&deg;C" title="Teplota" value="{{$temperature}}" path="M580-240q25 0 42.5-17.5T640-300q0-25-17.5-42.5T580-360q-25 0-42.5 17.5T520-300q0 25 17.5 42.5T580-240Zm-202-2 260-260-56-56-260 260 56 56Zm2-198q25 0 42.5-17.5T440-500q0-25-17.5-42.5T380-560q-25 0-42.5 17.5T320-500q0 25 17.5 42.5T380-440ZM480-80q-137 0-228.5-94T160-408q0-100 79.5-217.5T480-880q161 137 240.5 254.5T800-408q0 140-91.5 234T480-80Zm0-80q104 0 172-70.5T720-408q0-73-60.5-165T480-774Q361-665 300.5-573T240-408q0 107 68 177.5T480-160Zm0-320Z"/>
            <x-value-with-icon-inline unit="" title="Vlhkost" value="{{$humidity}}" path="M520-520v-80h200v80H520Zm0-160v-80h320v80H520ZM320-120q-83 0-141.5-58.5T120-320q0-48 21-89.5t59-70.5v-240q0-50 35-85t85-35q50 0 85 35t35 85v240q38 29 59 70.5t21 89.5q0 83-58.5 141.5T320-120ZM200-320h240q0-29-12.5-54T392-416l-32-24v-280q0-17-11.5-28.5T320-760q-17 0-28.5 11.5T280-720v280l-32 24q-23 17-35.5 42T200-320Z"/>
