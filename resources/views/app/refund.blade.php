        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="overflow-hidden shadow-sm sm:rounded-lg flex flex-col gap-6">
                ...
                <div class="dark:bg-gray-800 bg-white p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <ul class="block flex flex-wrap mt-4 gap-6">
                        <li class="p-5 border border-gray-500 rounded-lg w-40 h-40 flex flex-col">
                            ...
                            <h3 class="font-semibold text-3xl">24.3 &deg;C</h3>
                            <p class="text-gray-400">Teplota</p>
                        </li>
                        <li class="p-5 border border-gray-500 rounded-lg w-40 h-40 flex flex-col">
                            <svg
                                class="h-10 w-10 mb-2"
                            ...
                            <h3 class="font-semibold text-3xl">34 %</h3>
                            <p class="text-gray-400">Vlhkost</p>
                        </li>
                        <li class="p-5 border border-gray-500 rounded-lg w-40 h-40 flex flex-col">
                            <svg
                                class="h-10 w-10 mb-2"
                            ...
                            <h3 class="font-semibold text-3xl">Ano</h3>
                            <p class="text-gray-400">V rovině?</p>
                        </li>
                        <li class="p-5 border border-gray-500 rounded-lg w-40 h-40 flex flex-col">
                            <svg
                                class="h-10 w-10 mb-2"
                                ...
                                <path
                                    class="fill-current text-gray-300"
                                    d="M480-800 243-663l237 137 237-137-237-137ZM120-321v-318q0-22 10.5-40t29.5-29l280-161q10-5 19.5-8t20.5-3q11 0 21 3t19 8l280 161q19 11 29.5 29t10.5 40v159h-80v-116L479-434 200-596v274l240 139v92L160-252q-19-11-29.5-29T120-321ZM720-80q8 0 14-6t6-14q0-8-6-14t-14-6q-8 0-14 6t-6 14q0 8 6 14t14 6Zm-20-80h40v-160h-40v160ZM720 0q-83 0-141.5-58.5T520-200q0-83 58.5-141.5T720-400q83 0 141.5 58.5T920-200q0 83-58.5 141.5T720 0ZM480-491Z"/>
                            </svg>
                            <h3 class="font-semibold text-3xl">6 x</h3>
                            <p class="text-gray-400">Náraz</p>
                        </li>
                        <li class="p-5 border border-gray-500 rounded-lg w-40 h-40 flex flex-col">
                            <svg
                                class="h-10 w-10 mb-2"
                        ...
                        <script>
                            ...
                            new Chart(ctx, {
                                ...
                                data: {
                                    ...
                                    datasets: [{
                                        label: 'Teplota zásilky #2341-12-2024',
                        ...
                        <script>
                            ...
                            new Chart(ctx2, {
                                ...
                                data: {
                                    labels: ['Pondělí', 'Úterý', 'Středa', 'Čtvrtek', 'Pátek', 'Sobota'],
                                    datasets: [{
                                        label: 'Počet nárazů zásilky #2341-12-2024',
                                        data: [0,0,2,1,0,3],
                                        borderWidth: 2,
                                        // borderColor: '#1b4332',
                                        // backgroundColor: '#2d6a4f',
